...
public class FunctionalityTesting
{
	...
	{
		DiplomaWork work = new DiplomaWork(	"name",
											"diplomants",
											new Person("Leader", dateList()),
											new Person("Reviewer", dateList()),
											"Game");
...
//		jury = jury();
//
//		DiplomaWork diplomaWork = new DiplomaWork(	"name",
//													"diplomants",
//													new Person("Leader", dateList()),
//													new Person("Reviewer", dateList()),
//													"type");
...
//	}
	...
	public void lessThan9Generation()
	{
		...
		works.add(new DiplomaWork(	"name",
									"diplomants",
									new Person("Leader1", dateList()),
									new Person("Reviewer1", dateList()),
									"type"));
		works.add(new DiplomaWork(	"name",
									"diplomants",
									new Person("Leader2", dateList()),
									new Person("Reviewer2", dateList()),
									"type"));
		works.add(new DiplomaWork(	"name",
									"diplomants",
									new Person("Leader3", dateList()),
									new Person("Reviewer3", dateList()),
									"type"));
		works.add(new DiplomaWork(	"name",
									"diplomants",
									new Person("Leader1", dateList()),
	...
	public ArrayList<DiplomaWork> softwareWorks()
	{
		...
		softArray.add(new DiplomaWork(	"name",
										"diplomants",
										new Person("Leader", dateList()),
										new Person("Reviewer", dateList()),
										"type"));
