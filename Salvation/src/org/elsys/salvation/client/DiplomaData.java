...
public class DiplomaData
{
	...
	public void getHardDefences()
	{
		for (int i = 0; i < fm.getHardDefences().size(); i++)
		{
			...
			{
				DiplomaRecord record = new DiplomaRecord(	fm.getHardDefences()
																.get(i)
																.getDiplomaWorks()
																.get(k)
																.getName(),
	...
	public void getSoftDefences()
	{
		for (int i = 0; i < fm.getSoftDefences().size(); i++)
		{
			...
			{
				DiplomaRecord record = new DiplomaRecord(	fm.getSoftDefences()
																.get(i)
																.getDiplomaWorks()
																.get(k)
																.getName(),
	...
	public void getNetDefences()
	{
		for (int i = 0; i < fm.getNetDefences().size(); i++)
		{
			...
			{
				DiplomaRecord record = new DiplomaRecord(	fm.getNetDefences()
																.get(i)
																.getDiplomaWorks()
																.get(k)
																.getName(),
